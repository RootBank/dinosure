          ...
          <section className='section'>
            <div className='level form-nav'>
              <div className='level-item'>
                <Link href='/quote/age'><button className='button is-primary is-inverted'><a>Prev</a></button></Link>
                <Link href='/quote/income'><button className='button is-primary' disabled={this.state.nextDisabled}>Next</button></Link>
              </div>
            </div>
          </section>
