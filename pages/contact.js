  ...
  <section className='section' >
    <div className='container'>
      <div className='content'>
        <h1 className='title has-text-centered'>We really like talking to fellow Heros</h1>
        <p>
          If you have any questions, queries or just want to say hello, you can find the little green bubble on the right hand corner of your screen. Just click on it and a fellow Hero will be there to help you... or just to listen if you need someone to talk to.
        </p>
      </div>
      <div className='content'>
